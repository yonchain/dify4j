 ...
 * @author Cgy
 */
public class Dify4jDelegatingPasswordEncoder implements PasswordEncoder {
    ...
    public Dify4jDelegatingPasswordEncoder() {
        delegatingPasswordEncoder = new DelegatingPasswordEncoder(DEFAULT_ID, this.createDefaultPasswordEncoder());
    }

    public Dify4jDelegatingPasswordEncoder(Map<String, PasswordEncoder> idToPasswordEncoder) {
        this(DEFAULT_ID, idToPasswordEncoder);
    }

    public Dify4jDelegatingPasswordEncoder(String idForEncode, Map<String, PasswordEncoder> idToPasswordEncoder) {
