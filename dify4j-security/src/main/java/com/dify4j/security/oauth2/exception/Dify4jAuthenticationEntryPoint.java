package com.dify4j.security.oauth2.exception;
 ...
 * 处理未认证的请求，返回统一的错误格式
 */
public class Dify4jAuthenticationEntryPoint implements AuthenticationEntryPoint {

    private static final Logger log = LoggerFactory.getLogger(Dify4jAuthenticationEntryPoint.class);
    
    private final ObjectMapper objectMapper;

    public Dify4jAuthenticationEntryPoint(ObjectMapper objectMapper) {
