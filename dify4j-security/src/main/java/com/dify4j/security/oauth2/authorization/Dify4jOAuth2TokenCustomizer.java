 ...
 * @since 1.0.0
 */
public class Dify4jOAuth2TokenCustomizer implements OAuth2TokenCustomizer<JwtEncodingContext> {

    private static final Logger logger = LoggerFactory.getLogger(Dify4jOAuth2TokenCustomizer.class);
    ...
    private void addUserInformation(JwtEncodingContext context, JwtClaimsSet.Builder claims) {
        ...
        if (principal instanceof Dify4jOAuth2AuthorizationToken token){
