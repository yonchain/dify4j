 ...
 * @since 1.0.0
 */
@ImportRuntimeHints(Difj4jJdbcRegisteredClientRepository.Difj4jJdbcRegisteredClientRepositoryRuntimeHintsRegistrar.class)
public class Difj4jJdbcRegisteredClientRepository implements RegisteredClientRepository {
    ...
    /**
     * Constructs a {@code Difj4jJdbcRegisteredClientRepository} using the provided parameters.
     *
     * @param jdbcOperations the JDBC operations
     */
    public Difj4jJdbcRegisteredClientRepository(JdbcOperations jdbcOperations) {
    ...
    public void save(RegisteredClient registeredClient) {
        ...
        if (existingRegisteredClient != null) {
            //取消更新保存，因为如果客户端密钥的算法如果是{noop}，密码编码器DelegatingPasswordEncoder会重新将密钥重新编码，
            // 导致客户端信息显示到页面是加密的无法查看
    ...
    public static class RegisteredClientRowMapper implements RowMapper<RegisteredClient> {
        ...
        public RegisteredClientRowMapper() {
            ClassLoader classLoader = Difj4jJdbcRegisteredClientRepository.class.getClassLoader();
    ...
    static class Difj4jJdbcRegisteredClientRepositoryRuntimeHintsRegistrar implements RuntimeHintsRegistrar {
