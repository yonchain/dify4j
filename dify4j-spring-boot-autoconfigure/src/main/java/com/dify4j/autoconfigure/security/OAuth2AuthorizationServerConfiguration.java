...
import com.dify4j.security.oauth2.authorization.dify.CustomCodeAuthenticationConverter;
import com.dify4j.security.oauth2.authorization.dify.CustomCodeAuthenticationProvider;
...
public class OAuth2AuthorizationServerConfiguration {
    ...
    private void configureTokenEndpoint(HttpSecurity http,
        ...
        configurer.tokenEndpoint(endpoint -> {
            ...
            // 添加自定义code认证方式
            endpoint.accessTokenRequestConverter(new CustomCodeAuthenticationConverter());
            endpoint.authenticationProvider(new CustomCodeAuthenticationProvider(
