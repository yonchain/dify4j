...
import com.dify4j.api.idm.enums.MenuType;
import com.dify4j.api.idm.Menu;
import com.dify4j.api.idm.Role;
import com.dify4j.api.idm.User;
...
import com.dify4j.constants.UserStatusConstant;
import com.dify4j.idm.entity.TenantAccountJoinEntity;
import com.dify4j.idm.mapper.MenuMapper;
import com.dify4j.idm.mapper.RoleMapper;
import com.dify4j.idm.mapper.TenantAccountJoinMapper;
import com.dify4j.idm.mapper.UserMapper;
...
public class UserServiceImpl implements UserService {
    ...
    private final TenantAccountJoinMapper tenantAccountJoinMapper;

    public UserServiceImpl(UserMapper userMapper, SecurityService securityService,
                           RoleMapper roleMapper, TenantAccountJoinMapper tenantAccountJoinMapper,
    ...
    public void createUser(String tenantId, User user, List<String> roleIds) {
        ...
        //添加到用户与租户关联表
        TenantAccountJoinEntity tenantAccountJoinEntity = new TenantAccountJoinEntity();
    ...
    public void resetPassword(String userId, String oldPassword, String newPassword) {
        ...
        if (user == null) {
            throw new Dify4jResourceNotFoundException("账户不存在");
        }

        // 验证旧密码
        if (!securityService.matchesPassword(oldPassword, user.getPasswordSalt(), user.getPassword())) {
            throw new Dify4jIllegalStateException("旧密码不正确");
        }
