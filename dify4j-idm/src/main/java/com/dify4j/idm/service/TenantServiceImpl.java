...
import com.dify4j.api.idm.enums.RoleCategory;
import com.dify4j.api.idm.enums.RoleGroupCategory;
import com.dify4j.api.idm.enums.RoleType;
...
public class TenantServiceImpl implements TenantService {
    ...
    public TenantServiceImpl(TenantMapper tenantMapper, TenantAccountJoinMapper tenantAccountJoinMapper,
    ...
    public Page<Tenant> pageTenants(String userId, Map<String, Object> queryParam, int pageNum, int pageSize) {
        ...
        List<Tenant> tenants = tenantMapper.selectList(userId, queryParam);
        return PageUtil.convert(tenants);
    }
    ...
    public void createTenant(Tenant tenant, String userId) {
        ...
        // 创建租户与账号、角色的关联
        TenantAccountJoinEntity tenantAccountJoin = new TenantAccountJoinEntity();
