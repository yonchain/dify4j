...
import com.dify4j.api.idm.DefaultMenuTree;
import com.dify4j.api.idm.Menu;
import com.dify4j.api.idm.MenuService;
import com.dify4j.api.idm.MenuTree;
import com.dify4j.idm.mapper.MenuMapper;
import com.dify4j.idm.mapper.RoleMenuMapper;
...
public class MenuServiceImpl implements MenuService {
    ...
    public void deleteMenuById(String id) {
        ...
        if (menuList != null && !menuList.isEmpty()) {
            throw new Dify4jForbiddenException("存在子节点，不允许删除");
        }
