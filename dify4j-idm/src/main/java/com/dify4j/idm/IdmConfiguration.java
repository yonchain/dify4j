...
public class IdmConfiguration {
    ...
    protected TenantAccountJoinMapper tenantAccountJoinMapper;
    ...
    protected IdmConfiguration(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder tenantAccountJoinMapper(TenantAccountJoinMapper tenantAccountJoinMapper) {
         ...
         */
        public IdmConfiguration build() {
            validate();
            return new IdmConfiguration(this);
        }
